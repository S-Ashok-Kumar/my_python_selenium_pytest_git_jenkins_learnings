"""
Command to execute:
                    python -m pytest PlaywrightWithPython/test_pw_datadriven_login_csv_15.py -s -v --headed
...
from PlaywrightWithPython.test_pw_datadriven_login_json_15 import login_data

login_data = []
# Read csv file
path = "PlaywrightWithPython/testdata/data.csv"
...
def test_datadriven_csv_login(email, password, validity, page: Page):
